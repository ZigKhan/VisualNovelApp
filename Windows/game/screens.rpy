    ...
    use game_menu(_("Preferences"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("lado do Retorno")
                    textbutton _("Desativar") action Preference("rollback side", "disable")
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Avançar o tempo automáticamente")
...
screen history():
    ...
    use game_menu(_("History"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
        ...
        if not _history_list:
            label _("o histórico de diálogos esta vazio.")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Avança diálogo e interage com a interface.")

    hbox:
        label _("Espaço")
        text _("Avança diálogo sem fazer escolhas.")

    hbox:
        label _("Teclas de Seta")
        text _("Navega na interface.")

    hbox:
        label _("Escape")
        text _("Acessa o Menu.")

    hbox:
        label _("Ctrl")
        text _("Passa diálogo quando pressionado.")

    hbox:
        label _("Tab")
        text _("Ativa/Desativa o skip no diálogo.")

    hbox:
        label _("Page Up")
        text _("Volta a um diálogo anterior.")

    hbox:
        label _("Page Down")
        text _("Avança para um diálogo posterior.")
    ...
    hbox:
        label "S"
        text _("Tira um print da tela.")

    hbox:
        label "V"
        text _("Ativa {a=https://www.renpy.org/l/voicing}Auto-voz{/a}.")
...
screen mouse_help():
    ...
    hbox:
        ...
        text _("Volta a um diálog anterior.")

    hbox:
        label _("Roda do mouse para baixo")
        text _("Avança o jogo.")
